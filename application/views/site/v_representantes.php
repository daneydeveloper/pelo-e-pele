<div class="page-wraper">
   <div class="text-center p-a10">
      <h1>Nossos <span class="text-primary">Representantes</span> pelo o Brasil</h1>
      <p>Clique em um dos estados do mapa ao lado e visualize seu respectivo representante e dados de contato.</p>
   ...
   <div class="container">
      <div id="container_mapa">
         <div class="ladoLeft">
            <style>
               #container_mapa{float:left;width:98%;margin:1%;}
               .ladoLeft{width:48%;float:left;margin:1%;}
               .ladoRight{width:48%;float:left;margin:1%;}
               .display{float:left;display:none;width:100%;font-family:Poppins;}
               .display h2{padding:0;margin:0;text-align:left;margin-top:25px;margin-left:25px;}
               .display h4{padding:0;margin:0px 0px 10px 0px;text-align:left;margin-left:25px;}
               .display p{padding:0;margin:0;text-align:left;margin-left:25px;color: #4c4c4c;}
               .styleFont p{font-family: Poppins,Poppins,sans-serif;font-feature-settings: normal;font-size: 14px;}
               @media (max-width: 769px){
               .ladoLeft{width:98%;float:left;margin:1%;}
               .ladoRight{width:98%;float:left;margin:1%;}
               }
            </style>
            <style>
               #svg-map path {fill: #8aaa38}
               #svg-map text {fill:#fff; font:12px Poppins, sans-serif; cursor:pointer }
               #svg-map a{text-decoration:none }
               #svg-map a:hover { cursor:pointer; text-decoration:none }
               #svg-map a:hover path{fill: #4b5d1f !important}
               #svg-map .circle { fill:#779231 }
               #svg-map a:hover .circle { fill:#4b5d1f !important; cursor:pointer }
               h2,.ladoRight{
                  font-size: 24px!important;
               }
            </style>
            <svg version="1.1" id="svg-map" xmlns="//www.w3.org/2000/svg" xmlns:xlink="//www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
               <g>
                  <a  id="TO" class="button tocantins">
                  ...
                  <a  id="PE" class="button pernambuco">
                  ...
                  <a  id="RN" class="button riograndedonorte">
                  ...
                  <a  id="MT" class="button matogrosso">
                  ...
                  <a  id="MS" class="button mattogrossodosul">
                  ...
                  <a  id="SC" class="button santacatarina">
                  ...
                  <a  id="RS" class="button riograndedosul">
                  ...
                  <a id="MG" class="button minasgerais">
                  ...
                  <a  id="RJ" class="button riodejaneiro">
                  ...
                  <a  id="ES" class="button espiritosanto">
                  ...
                  <a  id="DF" class="button distritofederal" >
         ...
         <div class="ladoRight">
            ...
            <?php foreach ($colaboradores as $key): ?>
               <div class="<?=$key->REPRE_Cidade?> styleFont display">
                  <h2><?=$key->REPRE_Cidade?></h2>
               </div>
               <div class="<?=$key->REPRE_Cidade?> styleFont display">
                 <?php foreach ($key->colaboradores as $key2): ?>
                     <h2><?=limpar_string($key2->REPRE_Nome)?></h2>
                     <!-- <p>Endereço:   <?=$key2->REPRE_Endereco?></p> -->
                     <p>Telefone: <?=$key2->REPRE_Telefone?></p>
                     <!-- <p><?=$key2->REPRE_Email?></p> -->
                 <?php endforeach ?>
               </div>
            <?php endforeach ?>
         </div>
