               ...
               <div class="col-md-9">
                  ...
                  <div class="row">
                     <?php foreach ($produtos as $key): ?>
                        <a href="<?=base_url('site/produto_detalhe/'.$key->PRO_Codigo)?>">
                           <div class="col-md-4 col-sm-4 col-xs-12 col-xs-100pc m-b30">
                              <div class="wt-box wt-product-box border-red height-fixed">
                                 <div class="wt-thum-bx wt-img-effect">
                                    <img id="imgprodutos" src="<?=base_url('public/admin/img/produtos/'.$key->imagem->PROIMG_Imagem)?>" alt="">
                                 </div>
                                 <div class="wt-info  text-center">
                                    <div class="p-a10">
                                       <h4 class="wt-title">
                                          <a href=""><?=$key->PRO_Nome?></a>
                                       </h4>
                                       <p id="#descricaocurta"><?=$key->PRO_Descricao_Curta?></p>
                                       <div class="p-t10">
                                          <a href="<?=base_url('site/produto_detalhe/'.$key->PRO_Codigo)?>" class="site-button" type="button" >Mais Informações <i class="fa fa-plus"></i></a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="row">
                        <div class="col-md-12 col-sm-12">
                           <div class="wt-box pro-banner">
                              <img src="<?=base_url()?>/public/tema/images/add/pic1.jpg">
                              <div class="pro-banner-disc p-a20 text-white">
                                 <h2 class="text-uppercase m-a0 m-b10">OFERTA ESPECIAL</h2>
                                 <h4 class="m-a0 m-b10">Produto em destaque</h4>
