                     ...
                     <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                           <?php foreach ($usuarios as $key): ?>
                              <tr>
                                 <td><?=$key->USR_Codigo?></td>
                                 <td><?=$key->USR_Nome?></td>
                                 <td><?=$key->USR_Email?></td>
                                 <td><?=$key->USR_Nivel?></td>
                                 <td>
                                    <a href="<?=base_url('usuario/visualizar/'.$key->USR_Codigo)?>" class="btn btn-editar-produto" data-toggle="tooltip" title="" data-original-title="Editar Usuario"><i class="icon-spanner"></i></a>
                                    <!-- <a href="" class="btn btn-visualizar-produto" data-toggle="tooltip" title="" data-original-title="Visualizar Usuario"><i class="icon-eye2"></i></a> -->
                                    <a href="<?=base_url('usuario/remover/'.$key->USR_Codigo)?>" class="btn btn-excluir-produto" data-toggle="tooltip" title="" data-original-title="Excluir Usuario"><i class="icon-times"></i></a>
                                 </td>
                              </tr>
                           <?php endforeach ?>
                        </tbody>
