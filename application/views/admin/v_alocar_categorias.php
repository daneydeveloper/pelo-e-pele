      ...
      <div class="main-content">
         <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
               <div class="row gutters">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                     <form method="POST" action="<?=base_url('categoria/alocar/')?>" enctype="multipart/form-data">
                        <div class="card">
                           <input type="hidden" name="id_velho" value="<?=$id_velho?>">
                           <div class="card-body">
                              <div class="form-row">
                                 <div class="form-group col-md-12">
                                    <p>Está categoria está ligada a alguns produtos. Selecione uma nova categoria para estes produtos antes de remover a categoria atual.</p>
                                 </div>
                                 <div class="form-group col-md-12">
