      ...
      <div class="main-content">
         <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
               <div class="row gutters">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                     <form method="POST" action="<?=base_url('categoria/alterar/'.$categoria->PROCAT_Codigo)?>" enctype="multipart/form-data">
                        <div class="card">
                           ...
                           <div class="card-body">
                              <div class="form-row">
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="hidden" value="<?=$categoria->PROCAT_Codigo?>"  name="PROCAT_Codigo">
                                    <input required="true" type="text" class="form-control" name="PROCAT_Nome" value="<?=$categoria->PROCAT_Nome?>" placeholder="Digite o nome do usuario:" style="height: 40px;">
                                 </div>
                              </div>
