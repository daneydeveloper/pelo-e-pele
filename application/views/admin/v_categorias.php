                     ...
                     <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                           <?php foreach ($categorias as $key): ?>
                              <tr>
                                 <td><?=$key->PROCAT_Codigo?></td>
                                 <td><?=$key->PROCAT_Nome?></td>
                                 <!-- <td><?=$key->PRO_Codigo?></td> -->
                                 <td>
                                    <a href="<?=base_url('categoria/visualizar/'.$key->PROCAT_Codigo)?>" class="btn btn-editar-produto" data-toggle="tooltip" title="" data-original-title="Editar Categoria"><i class="icon-spanner"></i></a>
                                    <a href="<?=base_url('categoria/remover/'.$key->PROCAT_Codigo)?>" class="btn btn-excluir-produto" data-toggle="tooltip" title="" data-original-title="Excluir Categoria"><i class="icon-times"></i></a>
                                 </td>
                              </tr>
                           <?php endforeach ?>
                        </tbody>
