                        ...
                        <tbody>
                           <?php foreach ($produtos as $key): ?>
                              <tr>
                                 ...
                                 <!-- <td><?=$key->PRO_Codigo?></td> -->
                                 <td>
                                    <a href="<?=base_url('produto/visualizar/'.$key->PRO_Codigo)?>" class="btn btn-editar-produto" data-toggle="tooltip" title="" data-original-title="Editar Produto"><i class="icon-spanner"></i></a>
                                    <a href="<?=base_url('produto/remover/'.$key->PRO_Codigo)?>" class="btn btn-excluir-produto" data-toggle="tooltip" title="" data-original-title="Excluir Produto"><i class="icon-times"></i></a>
                                 </td>
                              </tr>
                           <?php endforeach ?>
                        </tbody>
