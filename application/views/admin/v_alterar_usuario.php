      ...
      <div class="main-content">
         <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
               <div class="row gutters">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                     <form method="POST" action="<?=base_url('usuario/alterar/'.$usuarios->USR_Codigo)?>" enctype="multipart/form-data">
                        <div class="card">
                           ...
                           <div class="card-body">
                              <div class="form-row">
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="hidden" value="<?=$usuarios->USR_Codigo?>"  name="USR_Codigo">
                                    <input required="true" type="text" class="form-control" name="USR_Nome" value="<?=$usuarios->USR_Nome?>" placeholder="Digite o nome do usuario:" style="height: 40px;">
                                 </div>
                                 <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input required="true" type="password" class="form-control" name="USR_Senha" value="<?=$usuarios->USR_Senha?>" placeholder="Digite a senha do usuario:" style="height: 40px;">
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label class="col-form-label">Nivel: *</label>
                                    <input required="true" type="text" class="form-control" name="USR_Nivel" value="<?=$usuarios->USR_Nivel?>" placeholder="Digite o nivel do funcionario:" style="height: 40px;">
                                 </div>
                                 <div class="form-group col-md-6">
                                    <?php if ($usuarios->USR_Imagem): ?>
                                       <img class="thumbnail" style="height: 100%;width: 30%;" src="<?=base_url('public/admin/img/usuarios/'.$usuarios->USR_Imagem)?>">
                                    <?php endif ?>
                                 </div>
                                 <div class="form-group col-md-6">
                              ...
                              <button type="submit" class="btn btn-cadastrar">ALTERAR</button>
                              <br>
                              <?php if (@$error): ?>
