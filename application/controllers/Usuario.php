...
class Usuario extends CI_Controller
{
    ...
    public function cadastrar()
    {
        if ($_POST) {
            ...
            $query               = $this->m_usuario->cadastrar($dados);
            if ($query) {
                $retorno['success'] = TRUE;
                $retorno['msg']     = 'Usuario castrado com sucesso.';
            } else {
                $retorno['error'] = FALSE;
                $retorno['msg']   = 'Ocorreu um erro ao cadastrar um Usuario';
            }
            
            $this->template->make_admin('v_cadastro_usuario', $retorno);
        }
    }
